...
public partial class TruMarkTestScriptParser : Parser {
	...
	public ProgramContext program() {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__23) | (1L << T__24) | (1L << T__25) | (1L << T__26) | (1L << T__27) | (1L << WHILE) | (1L << CALL) | (1L << IDENTIFIER) | (1L << FUNCTIONIDENTIFIER))) != 0)) {
				{
				{
				State = 58;
				line();
	...
	private static int[] _serializedATN = {
		4,1,44,249,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,7,
		...
		38,40,42,44,46,48,50,52,54,56,0,6,1,0,12,14,1,0,15,16,1,0,17,23,1,0,34,
		38,1,0,30,31,1,0,24,28,252,0,61,1,0,0,0,2,69,1,0,0,0,4,75,1,0,0,0,6,77,
		...
		29,0,0,98,99,3,24,12,0,99,102,3,10,5,0,100,101,5,2,0,0,101,103,3,8,4,0,
		102,100,1,0,0,0,102,103,1,0,0,0,103,13,1,0,0,0,104,105,5,40,0,0,105,106,
		5,5,0,0,106,107,3,24,12,0,107,15,1,0,0,0,108,109,5,41,0,0,109,118,5,6,
		...
		8,0,0,121,17,1,0,0,0,122,123,5,32,0,0,123,124,5,41,0,0,124,133,5,6,0,0,
		...
		136,19,1,0,0,0,137,138,5,42,0,0,138,147,5,6,0,0,139,144,3,24,12,0,140,
		...
		5,41,0,0,152,153,5,9,0,0,153,154,5,36,0,0,154,155,5,36,0,0,155,156,5,36,
		0,0,156,157,5,10,0,0,157,23,1,0,0,0,158,159,6,12,-1,0,159,172,3,34,17,
		0,160,172,5,40,0,0,161,172,3,16,8,0,162,172,3,18,9,0,163,172,3,20,10,0,
		...
		5,33,0,0,201,33,1,0,0,0,202,203,7,3,0,0,203,35,1,0,0,0,204,206,3,38,19,
		0,205,204,1,0,0,0,205,206,1,0,0,0,206,207,1,0,0,0,207,208,5,40,0,0,208,
		...
		240,3,56,28,0,240,55,1,0,0,0,241,247,5,40,0,0,242,243,5,6,0,0,243,244,
